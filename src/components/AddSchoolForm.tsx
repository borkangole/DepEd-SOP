...
export default function AddSchoolForm() {
  ...
  return (
    <form ref={formRef} action={formAction} className="mt-2 flex flex-col gap-2 rounded-md border border-slate-200 bg-slate-50 p-3">
      ...
      <label className="flex items-center gap-2 text-xs font-medium text-slate-600">
        <input type="checkbox" name="is_remote" className="rounded border-slate-300" />
